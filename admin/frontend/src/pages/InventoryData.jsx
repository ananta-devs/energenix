...
import { Package, AlertCircle, CheckCircle, XCircle, Search, TrendingDown, Plus, X } from 'lucide-react';
...
const InventoryData = () => {
  ...
  const getStockStatus = (currentStock) => {
    ...
    if (currentStock <= MINIMUM_STOCK_THRESHOLD) return { text: 'Low Stock', color: 'text-yellow-600', icon: <AlertCircle size={14} /> };
    return { text: 'Adequate', color: 'text-green-600', icon: <CheckCircle size={14} /> };
  };
